...
n1.read_pnts('./input/Section3.2_data/QSCW912017.DZJ')  
print(n1) 
...
s1.read_survey_file('./input/Section3.2_data/sim-SD1.C098')
...
gravwork.add_ag_from_file('./input/Section3.2_data/Section3.2_AG.txt')
...
gravwork.run_adj('./input/Section3.2_data/grav_baj.txt', 2)
# Output adjustment results
gravwork.export_station('./output/Section3.2_output/dz201708.txt') #gravity value
gravwork.export_dc('./output/Section3.2_output/dc201708.txt')  # gravity difference (unique)
gravwork.export_dc_all('./output/Section3.2_output/d_to_d201708.txt') # gravity difference (back "-" and forth "+")
# export all parameters
grav_dict1 = json.load(open('./input/Section3.2_data/grav_baj.txt'))
